  ...
  return (
    <main className="auth-page">
      <div className="auth-card">
        ...
        <p className="auth-sub">Regístrate para poder añadir proyectos.</p>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="field">
            ...
            <input id="password" className="field__input" type="password" placeholder="Mínimo 8 caracteres"
        ...
        <p className="auth-link">¿Ya tienes cuenta? <Link href="/sign-in">Inicia sesión</Link></p>
      </div>
